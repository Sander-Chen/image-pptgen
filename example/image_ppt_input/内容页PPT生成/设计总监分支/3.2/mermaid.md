...
flowchart TB
    ...
    classDef optionalNode fill:#f9f5ff,stroke:#9a85b0,stroke-width:1.5px,stroke-dasharray:4 2,color:#5a4570
    ...
    subgraph Phase1 [" "]
        ...
        CoverRef["封面参考图（可选）"]
        Text1["取第 1 页文本"]
        Designer1["初创设计师 V1.1<br/>Gemini 3 Pro"]
        Blueprint1["视觉蓝图"]
        Image1["Image 引擎"]
        Page1["第 1 页内容图"]
    end
